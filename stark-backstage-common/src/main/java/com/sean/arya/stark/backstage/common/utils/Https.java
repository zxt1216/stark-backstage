...
public class Https {
    ...
    static{
        ...
        https=HttpClients.createDefault();
        ...
        https=HttpClients.custom().setSSLSocketFactory(createSSLConnSocketFactory()).setConnectionManager(phcm).setDefaultRequestConfig(requestConfig).setRetryHandler(retryHandler).build();
    }
    private static SSLConnectionSocketFactory createSSLConnSocketFactory() {
        SSLConnectionSocketFactory sslsf = null;
        try {
            sslsf = new SSLConnectionSocketFactory(new SSLContextBuilder().loadTrustMaterial(null, (TrustStrategy) (xcs, string) -> true).build());
        } catch (KeyStoreException | NoSuchAlgorithmException | KeyManagementException ex) {
            log.error("SSLConnectionSocketFactory create exception",ex);
        }
        return sslsf;
    }
    public static String get(String url, Map<String,String> params, Map<String,String> headers) throws IOException {
        ...
        CloseableHttpResponse resp = https.execute(get);
    ...
    public static String post(String url,Map<String,String> params, Map<String,String> headers,Map<String,String> data)throws IOException{
        ...
        CloseableHttpResponse resp = https.execute(post);
        String result=parse(resp);
        return result;
    }
    /**
    ...
    public static Map<String,Object> login(String url, Map<String,String> params, Map<String,String> headers,Map<String,String> data)throws IOException{
        ...
        CloseableHttpResponse resp = https.execute(post,context);
